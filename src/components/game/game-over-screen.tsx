...
export function GameOverScreen({
  ...
  return (
    <>
      ...
      <main className="relative z-10 mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-8 px-5 py-12">
              ...
              return (
                <div
                  className={`flex items-center justify-between rounded-2xl px-4 py-3 ${
                    isWinner
                      ? "bg-yellow-300/15 ring-1 ring-yellow-300/40"
                      : "bg-white/5"
                  }`}
                  key={entry.playerId}
                >
        ...
        <section className="rounded-4xl border border-yellow-300/20 bg-yellow-300/5 p-6 text-center">
          ...
          <div className="mt-5 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a
              className="inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-white/15 bg-white/5 px-5 py-3 font-black text-white transition hover:bg-white/10 sm:w-auto"
              href={FEEDBACK_URL}
              rel="noreferrer"
              target="_blank"
            >
            ...
            <a
              className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[#FFDD00] px-5 py-3 font-black text-black shadow-lg transition hover:brightness-105 sm:w-auto"
